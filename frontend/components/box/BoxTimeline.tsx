...
export function BoxTimeline({ box, ocupacoes, data }: Props) {
  ...
  return (
    <div className="w-max md:w-full border-2 border-slate-200 dark:border-slate-700/50 rounded-lg hover:border-slate-300 dark:hover:border-slate-600 transition-all shadow-sm hover:shadow-md">
      <div className="flex gap-3 items-stretch min-w-[800px] md:min-w-0 md:w-full">
      ...
      {/* Timeline */}
      <div className="flex md:grid md:grid-cols-11 gap-1 md:gap-2 p-2.5 bg-white dark:bg-slate-900/40 min-w-[640px] md:min-w-0 md:flex-1">
        {horas.map(hora => {
          const slots = calcularOcupacao(hora);
          
          return (
            <div key={hora} className="w-12 md:w-auto min-w-0 flex-shrink-0 md:flex-shrink flex flex-col gap-1">
              {/* Label da hora */}
...
export function TimelineHeader() {
  ...
  return (
    <div className="w-max md:w-full flex gap-3 items-stretch mb-4 bg-slate-100 dark:bg-slate-800/50 p-3 rounded-lg border-2 border-slate-300 dark:border-slate-700 min-w-[800px] md:min-w-0">
      ...
      {/* Horas */}
      <div className="flex md:grid md:grid-cols-11 gap-1 md:gap-2 p-1 min-w-[640px] md:min-w-0 md:flex-1">
        {horas.map(hora => (
          <div key={hora} className="w-12 md:w-auto min-w-0 flex-shrink-0 md:flex-shrink">
